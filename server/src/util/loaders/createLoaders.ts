...
import { followersLoader } from '@/util/loaders/user/FollowersLoader'
import { followingLoader } from '@/util/loaders/user/FollowingLoader'
...
export function createLoaders(em: EntityManager, userId: string): Loaders {
  return {
    ...
    followersLoader: followersLoader(em, userId),
    followingLoader: followingLoader(em, userId),
