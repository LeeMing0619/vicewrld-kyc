...
export default function ServerList({ hide = false }) {
  ...
  const canCreate = currentUser?.isPremium || currentUser?.isAdmin
        ...
        <div className="h-full flex flex-col items-center w-full divide-y dark:divide-gray-800 divide-gray-200">
          <div className="space-y-2 flex flex-col items-center py-2">
            <ServerListItem
              ...
              className={`${
                homeActive
                  ? 'dark:bg-vicePink bg-white hover:bg-blue-600 dark:hover:bg-vicePink'
                  : 'dark:bg-gray-800 bg-white hover:bg-blue-600 dark:hover:bg-vicePink'
              }`}
            >
              <IconHome
                className={`w-5 h-5 group-hover:text-white transition ${
                  homeActive ? 'text-white' : 'text-white'
                }`}
              />
            </ServerListItem>
            ...
            <ServerListItem
              ...
              className={
                exploreActive
                  ? 'bg-vicePink'
                  : 'dark:bg-gray-800 bg-white hover:bg-green-600 dark:hover:bg-vicePink'
              }
            >
              <IconExplore
                className={`w-5 h-5 group-hover:text-white transition ${
                  exploreActive ? 'text-white' : 'text-white'
                }`}
              />
            </ServerListItem>
