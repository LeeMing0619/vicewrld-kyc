export const error = {
  ...
  server: {
    notJoined: 'You have not joined this room',
    banned: 'You are banned from this room',
    alreadyJoined: 'You have already joined this room',
    missingPermission: 'Missing room permission {{replace}}',
    notOwner: 'Must be room owner',
    inviteRequired: 'Invite required to join this room',
