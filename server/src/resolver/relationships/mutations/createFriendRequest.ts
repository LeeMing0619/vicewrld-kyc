...
export async function createFriendRequest(
  ...
  console.log(myData.status, 'doonchine')
  console.log(theirData.status, 'doonchine')
  ...
  myData.status = RelationshipStatus.Following
  theirData.status = RelationshipStatus.FollowedBy
