...
export default function ServerInfoCard({
  ...
  return (
    ...
    >
      <Link
        to={`/+${server.name}`}
        className={`${className} relative flex flex-col w-full rounded-lg group dark:bg-gray-800 dark:hover:bg-vicePinkLowOp duration-200 transform transition hover:shadow-xl bg-vicePink ${
          shadow ? 'bg-vicePinkLowOp' : ''
        }`}
      >
        <div
