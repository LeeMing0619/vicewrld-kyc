...
export type ChangeUserAvatarWithUrlInput = {
  newAvatarUrl: Scalars['String'];
};

export type ChangeUserBannerInput = {
...
export type Mutation = {
  ...
  blockUser: User;
  changeIsCreator: User;
  changeIsPremium: User;
  changeOnlineStatus: User;
  changePassword: User;
  changeUserAvatar: User;
  changeUserAvatarWithUrl: User;
  changeUserBanner: User;
  closeDm: User;
  ...
  updateFolder: Folder;
  updateGroup: Group;
  updateInstagram: Scalars['Boolean'];
  updateMessage: Message;
  updatePost: Post;
  updatePostVote: Post;
  updateRole: Role;
  updateServer: Server;
  updateTwitter: Scalars['Boolean'];
...
export type MutationChangeIsCreatorArgs = {
  input: Scalars['Boolean'];
};


export type MutationChangeIsPremiumArgs = {
  input: Scalars['Boolean'];
};
...
export type MutationChangeUserAvatarWithUrlArgs = {
  input: ChangeUserAvatarWithUrlInput;
};


export type MutationChangeUserBannerArgs = {
  input: ChangeUserBannerInput;
};
...
export type MutationUpdateInstagramArgs = {
...
export type UpdateInstagramInput = {
  newInstagram?: Maybe<Scalars['String']>;
  userId: Scalars['ID'];
};
...
export type UpdateTwitterInput = {
  newTwitter?: Maybe<Scalars['String']>;
  userId: Scalars['ID'];
};
...
export type User = BaseEntity & {
  ...
  color: Color;
  createdAt: Scalars['DateTime'];
  creatorApplicationId?: Maybe<Scalars['String']>;
  email?: Maybe<Scalars['EmailAddress']>;
  folders: Array<Folder>;
...
export type DetailedUserFragment = (
  { __typename?: 'User' }
  & { relatedUsers: Array<(
    { __typename?: 'User' }
    & Pick<User, 'showChat' | 'unreadCount'>
...
export type ChangeUserBannerMutationVariables = Exact<{
  input: ChangeUserBannerInput;
}>;


export type ChangeUserBannerMutation = (
  { __typename?: 'Mutation' }
  & { changeUserBanner: (
    { __typename?: 'User' }
    & CurrentUserFragment
...
export type ChangeUserAvatarWithUrlMutationVariables = Exact<{
  input: ChangeUserAvatarWithUrlInput;
}>;


export type ChangeUserAvatarWithUrlMutation = (
  { __typename?: 'Mutation' }
...
export type ChangeIsPremiumMutationVariables = Exact<{
  input: Scalars['Boolean'];
}>;


export type ChangeIsPremiumMutation = (
  { __typename?: 'Mutation' }
  & { changeIsPremium: (
    { __typename?: 'User' }
    & CurrentUserFragment
...
export type ChangeIsCreatorMutationVariables = Exact<{
  input: Scalars['Boolean'];
}>;


export type ChangeIsCreatorMutation = (
  { __typename?: 'Mutation' }
  & { changeIsCreator: (
    { __typename?: 'User' }
    & CurrentUserFragment
...
export type UpdateTwitterMutationVariables = Exact<{
  input: UpdateTwitterInput;
}>;


export type UpdateTwitterMutation = (
  { __typename?: 'Mutation' }
  & Pick<Mutation, 'updateTwitter'>
);

export type UpdateInstagramMutationVariables = Exact<{
  input: UpdateInstagramInput;
}>;
...
export type DetailedUserQueryVariables = Exact<{
  id?: Maybe<Scalars['ID']>;
  username?: Maybe<Scalars['String']>;
}>;


export type DetailedUserQuery = (
  { __typename?: 'Query' }
  & { user?: Maybe<(
    { __typename?: 'User' }
...
export const CurrentUserFragmentDoc = gql`
  ...
  groups {
    ...
    ${UserFragmentDoc}
${GroupFragmentDoc}`;
export const DetailedUserFragmentDoc = gql`
...
export const ChangeUserBannerDocument = gql`
  ...
  changeUserBanner(input: $input) {
    ...
    ${CurrentUserFragmentDoc}`;
export type ChangeUserBannerMutationFn = Apollo.MutationFunction<ChangeUserBannerMutation, ChangeUserBannerMutationVariables>;

/**
 * __useChangeUserBannerMutation__
 *
 * To run a mutation, you first call `useChangeUserBannerMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useChangeUserBannerMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [changeUserBannerMutation, { data, loading, error }] = useChangeUserBannerMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useChangeUserBannerMutation(baseOptions?: Apollo.MutationHookOptions<ChangeUserBannerMutation, ChangeUserBannerMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<ChangeUserBannerMutation, ChangeUserBannerMutationVariables>(ChangeUserBannerDocument, options);
      }
export type ChangeUserBannerMutationHookResult = ReturnType<typeof useChangeUserBannerMutation>;
export type ChangeUserBannerMutationResult = Apollo.MutationResult<ChangeUserBannerMutation>;
export type ChangeUserBannerMutationOptions = Apollo.BaseMutationOptions<ChangeUserBannerMutation, ChangeUserBannerMutationVariables>;
export const ChangeUserAvatarWithUrlDocument = gql`
  ...
  changeUserAvatarWithUrl(input: $input) {
    ...
    ${CurrentUserFragmentDoc}`;
export type ChangeUserAvatarWithUrlMutationFn = Apollo.MutationFunction<ChangeUserAvatarWithUrlMutation, ChangeUserAvatarWithUrlMutationVariables>;

/**
 * __useChangeUserAvatarWithUrlMutation__
 *
 * To run a mutation, you first call `useChangeUserAvatarWithUrlMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useChangeUserAvatarWithUrlMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [changeUserAvatarWithUrlMutation, { data, loading, error }] = useChangeUserAvatarWithUrlMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useChangeUserAvatarWithUrlMutation(baseOptions?: Apollo.MutationHookOptions<ChangeUserAvatarWithUrlMutation, ChangeUserAvatarWithUrlMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<ChangeUserAvatarWithUrlMutation, ChangeUserAvatarWithUrlMutationVariables>(ChangeUserAvatarWithUrlDocument, options);
      }
export type ChangeUserAvatarWithUrlMutationHookResult = ReturnType<typeof useChangeUserAvatarWithUrlMutation>;
export type ChangeUserAvatarWithUrlMutationResult = Apollo.MutationResult<ChangeUserAvatarWithUrlMutation>;
export type ChangeUserAvatarWithUrlMutationOptions = Apollo.BaseMutationOptions<ChangeUserAvatarWithUrlMutation, ChangeUserAvatarWithUrlMutationVariables>;
...
export const ChangeIsPremiumDocument = gql`
  ...
  changeIsPremium(input: $input) {
    ...
    ${CurrentUserFragmentDoc}`;
export type ChangeIsPremiumMutationFn = Apollo.MutationFunction<ChangeIsPremiumMutation, ChangeIsPremiumMutationVariables>;

/**
 * __useChangeIsPremiumMutation__
 *
 * To run a mutation, you first call `useChangeIsPremiumMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useChangeIsPremiumMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [changeIsPremiumMutation, { data, loading, error }] = useChangeIsPremiumMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useChangeIsPremiumMutation(baseOptions?: Apollo.MutationHookOptions<ChangeIsPremiumMutation, ChangeIsPremiumMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<ChangeIsPremiumMutation, ChangeIsPremiumMutationVariables>(ChangeIsPremiumDocument, options);
      }
export type ChangeIsPremiumMutationHookResult = ReturnType<typeof useChangeIsPremiumMutation>;
export type ChangeIsPremiumMutationResult = Apollo.MutationResult<ChangeIsPremiumMutation>;
export type ChangeIsPremiumMutationOptions = Apollo.BaseMutationOptions<ChangeIsPremiumMutation, ChangeIsPremiumMutationVariables>;
export const ChangeIsCreatorDocument = gql`
  ...
  changeIsCreator(input: $input) {
    ...
    ${CurrentUserFragmentDoc}`;
export type ChangeIsCreatorMutationFn = Apollo.MutationFunction<ChangeIsCreatorMutation, ChangeIsCreatorMutationVariables>;

/**
 * __useChangeIsCreatorMutation__
 *
 * To run a mutation, you first call `useChangeIsCreatorMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useChangeIsCreatorMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [changeIsCreatorMutation, { data, loading, error }] = useChangeIsCreatorMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useChangeIsCreatorMutation(baseOptions?: Apollo.MutationHookOptions<ChangeIsCreatorMutation, ChangeIsCreatorMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<ChangeIsCreatorMutation, ChangeIsCreatorMutationVariables>(ChangeIsCreatorDocument, options);
      }
export type ChangeIsCreatorMutationHookResult = ReturnType<typeof useChangeIsCreatorMutation>;
export type ChangeIsCreatorMutationResult = Apollo.MutationResult<ChangeIsCreatorMutation>;
export type ChangeIsCreatorMutationOptions = Apollo.BaseMutationOptions<ChangeIsCreatorMutation, ChangeIsCreatorMutationVariables>;
...
export const UpdateTwitterDocument = gql`
    mutation updateTwitter($input: UpdateTwitterInput!) {
  updateTwitter(input: $input)
}
    `;
export type UpdateTwitterMutationFn = Apollo.MutationFunction<UpdateTwitterMutation, UpdateTwitterMutationVariables>;

/**
 * __useUpdateTwitterMutation__
 *
 * To run a mutation, you first call `useUpdateTwitterMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateTwitterMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateTwitterMutation, { data, loading, error }] = useUpdateTwitterMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useUpdateTwitterMutation(baseOptions?: Apollo.MutationHookOptions<UpdateTwitterMutation, UpdateTwitterMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateTwitterMutation, UpdateTwitterMutationVariables>(UpdateTwitterDocument, options);
      }
export type UpdateTwitterMutationHookResult = ReturnType<typeof useUpdateTwitterMutation>;
export type UpdateTwitterMutationResult = Apollo.MutationResult<UpdateTwitterMutation>;
export type UpdateTwitterMutationOptions = Apollo.BaseMutationOptions<UpdateTwitterMutation, UpdateTwitterMutationVariables>;
export const UpdateInstagramDocument = gql`
    mutation updateInstagram($input: UpdateInstagramInput!) {
  updateInstagram(input: $input)
}
    `;
export type UpdateInstagramMutationFn = Apollo.MutationFunction<UpdateInstagramMutation, UpdateInstagramMutationVariables>;

/**
 * __useUpdateInstagramMutation__
 *
 * To run a mutation, you first call `useUpdateInstagramMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateInstagramMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateInstagramMutation, { data, loading, error }] = useUpdateInstagramMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useUpdateInstagramMutation(baseOptions?: Apollo.MutationHookOptions<UpdateInstagramMutation, UpdateInstagramMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateInstagramMutation, UpdateInstagramMutationVariables>(UpdateInstagramDocument, options);
      }
export type UpdateInstagramMutationHookResult = ReturnType<typeof useUpdateInstagramMutation>;
export type UpdateInstagramMutationResult = Apollo.MutationResult<UpdateInstagramMutation>;
export type UpdateInstagramMutationOptions = Apollo.BaseMutationOptions<UpdateInstagramMutation, UpdateInstagramMutationVariables>;
...
export const DetailedUserDocument = gql`
    query detailedUser($id: ID, $username: String) @live {
  user(id: $id, username: $username) {
    ...DetailedUser
  }
}
    ${DetailedUserFragmentDoc}`;

/**
 * __useDetailedUserQuery__
 *
 * To run a query within a React component, call `useDetailedUserQuery` and pass it any options that fit your needs.
 * When your component renders, `useDetailedUserQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useDetailedUserQuery({
 *   variables: {
 *      id: // value for 'id'
 ...
 * });
 */
export function useDetailedUserQuery(baseOptions?: Apollo.QueryHookOptions<DetailedUserQuery, DetailedUserQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<DetailedUserQuery, DetailedUserQueryVariables>(DetailedUserDocument, options);
      }
export function useDetailedUserLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<DetailedUserQuery, DetailedUserQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<DetailedUserQuery, DetailedUserQueryVariables>(DetailedUserDocument, options);
        }
export type DetailedUserQueryHookResult = ReturnType<typeof useDetailedUserQuery>;
export type DetailedUserLazyQueryHookResult = ReturnType<typeof useDetailedUserLazyQuery>;
export type DetailedUserQueryResult = Apollo.QueryResult<DetailedUserQuery, DetailedUserQueryVariables>;
